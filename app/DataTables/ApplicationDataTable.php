...
class ApplicationDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $showUrl = route('applications.show', $row->id);
    ...
    public function getColumns(): array
    {
        ...
        $column[] = Column::make('name')->name('name')->title('Nama Aplikasi')->attributes(['data-type' => 'text', 'data-name' => 'name', 'data-label' => 'Nama Aplikasi', 'data-value' => null]);
        $column[] = Column::make('slug')->name('slug')->title('Slug')->attributes(['data-type' => 'text', 'data-name' => 'slug', 'data-label' => 'Slug', 'data-value' => null]);
        $column[] = Column::make('website_url')->name('website_url')->title('Website')->attributes(['data-type' => 'text', 'data-name' => 'website_url', 'data-label' => 'Website', 'data-value' => null]);
    ...
    {
        return 'applications_' . date('Y-m-d_H-i-s');
    }
}
