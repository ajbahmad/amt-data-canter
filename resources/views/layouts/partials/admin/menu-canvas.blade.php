<div id="navbar-offcanvas-example-menu"
    ...
    <div class="lg:flex gap-2  items-center ">
        <div class="flex lg:hidden lg:p-0 p-5">
            <div class="brand-logo d-flex align-items-center justify-center">
                <a href="../index.html" class="text-nowrap logo-img">
                    <img src="../assets/images/logos/logo-light.svg" class="dark:hidden block rtl:hidden"
                        alt="Logo-Dark" />
                    <img src="../assets/images/logos/logo-dark.svg" class="dark:block hidden rtl:hidden rtl:dark:hidden"
                        alt="Logo-light" />

                    <img src="../assets/images/logos/logo-light-rtl.svg"
                        class="dark:hidden hidden rtl:block rtl:dark:hidden" alt="Logo-Dark" />
                    <img src="../assets/images/logos/logo-dark-rtl.svg"
        ...
        <div class="lg:p-0 p-5 lg:flex gap-2 items-center" data-simplebar="" style="height: calc(100vh - 100px)">
            <button type="button" class="hs-collapse-toggle py-2 flex justify-between w-full" id="hs-basic-collapse"
                data-hs-collapse="#hs-basic-collapse-apps">
                <div class="flex gap-2 text-dark dark:text-darklink">
                    <iconify-icon icon="solar:list-bold-duotone" class="text-2xl"></iconify-icon>
                    <span class="hide-menu text-fs_15 font-medium">Apps</span>
                </div>
                <i class="ti ti-chevron-right hs-collapse-open:rotate-180 text-darklink text-xl transition-all"></i>
            </button>
            <div id="hs-basic-collapse-apps"
                class="hs-collapse hidden w-full overflow-hidden transition-[height] duration-300"
                aria-labelledby="hs-basic-collapse">
                <div class="grid grid-cols-12 gap-6">
                    <div class="lg:col-span-8 col-span-12 flex items-stretch lg:px-8 lg:pr-0 px-0  pb-0">
                        <div class="grid grid-cols-12 lg:gap-3 w-full">
                            <div class="col-span-12 lg:col-span-6 flex items-stretch pb-2.5">
                                <ul class="flex flex-col gap-5">
                                    <li>
                                        <a href="app-chat.html" class="flex gap-3 items-center group relative ">
                                            <span
                                    ...
                                    <li>
                                        <a href="app-invoice.html" class="flex gap-3 items-center group relative ">
                                            <span
                                                class="bg-lightgray dark:bg-darkprimary  h-11 w-11 flex justify-center items-center rounded-sm">
                                    ...
                                    <li>
                                        <a href="app-contact.html" class="flex gap-3 items-center group relative ">
                                            <span
                                                class="bg-lightgray dark:bg-darkprimary  h-11 w-11 flex justify-center items-center rounded-sm">
                                    ...
                                    <li>
                                        <a href="app-email.html" class="flex gap-3 items-center group relative ">
                                            <span
                                                class="bg-lightgray dark:bg-darkprimary  h-11 w-11 flex justify-center items-center rounded-sm">
                            ...
                            <div class="col-span-12 lg:col-span-6 flex items-stretch">
                                <ul class="flex flex-col gap-5">
                                    <li>
                                        <a href="eco-shop.html" class="flex gap-3 items-center group relative ">
                                            <span
                                                class="bg-lightgray dark:bg-darkprimary  h-11 w-11 flex justify-center items-center rounded-sm">
                                    ...
                                    <li>
                                        <a href="app-calendar.html" class="flex gap-3 items-center group relative ">
                                            <span
                                                class="bg-lightgray dark:bg-darkprimary  h-11 w-11 flex justify-center items-center rounded-sm">
                                                <img src="../assets/images/svgs/icon-dd-date.svg" class="h-6 w-6">
                                            </span>
                                            <div class>
                                                <h6 class="text-fs_15  mb-1  group-hover:text-primary ">
                                                    Calendar App
                                    ...
                                    <li>
                                        <a href="app-contact2.html" class="flex gap-3 items-center group relative ">
                                            <span
                                                class="bg-lightgray dark:bg-darkprimary  h-11 w-11 flex justify-center items-center rounded-sm">
                                    ...
                                    <li>
                                        <a href="app-notes.html" class="flex gap-3 items-center group relative ">
                                            <span
                                                class="bg-lightgray dark:bg-darkprimary  h-11 w-11 flex justify-center items-center rounded-sm">
                            ...
                            <div
                                class="col-span-12 md:col-span-12 border-t border-border dark:border-darkborder hidden lg:flex items-stretch py-4 pr-8">
                                <div class="flex items-center justify-between w-full">
                                    <div class="flex items-center text-dark dark:text-white">
                                        <i class="ti ti-help text-lg text-dark dark:text-darklink"></i>
                                        <a href="page-faq.html"
                                            class="text-fs_15 font-bold text-dark dark:text-darklink ml-2 group-hover:text-primary">
                                            Frequently Asked Questions
                                        </a>
                                    </div>
                                    <a href="#"
                                        class="btn py-3 rounded-full text-white border-primary block px-7 hover:bg-primaryemphasis text-fs_15 hover:text-white ">
                                        Check
                                    </a>
                                </div>
                            </div>
            ...
            <a class="py-2 mb-2 text-dark dark:text-darklink flex gap-2.5" href="app-chat.html"
                aria-expanded="false">
                <iconify-icon icon="solar:chat-round-unread-line-duotone" class="text-xl"></iconify-icon>
                <span class="hide-menu font-medium">Chat</span>
            </a>
            <a class="py-2 mb-2 text-dark dark:text-darklink flex gap-2.5" href="app-calendar.html"
                aria-expanded="false">
                <iconify-icon icon="solar:calendar-add-line-duotone" class="text-xl"></iconify-icon>
                <span class="hide-menu font-medium">Calendar</span>
            </a>
            <a class="py-2 mb-2 text-dark dark:text-darklink flex gap-2.5" href="app-email.html"
                aria-expanded="false">
                <iconify-icon icon="solar:mailbox-line-duotone" class="text-xl"></iconify-icon>
                <span class="hide-menu font-medium">Email</span>
            </a>
        </div>
    </div>
</div>
