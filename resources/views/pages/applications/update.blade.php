    ...
    <form action="{{ route('applications.update', $application->id) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="3"
                ...
                placeholder="Masukkan deskripsi aplikasi">{{ old('description', $application->description) }}</textarea>
            @error('description')
                <p class="mt-2 text-sm text-red-500"><i class="ti ti-alert-circle mr-1"></i>{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="website_url" name="website_url" value="{{ old('website_url', $application->website_url) }}"
            ...
            <div>
                ...
                <input type="text" id="logo_url" name="logo_url" value="{{ old('logo_url', $application->logo_url) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="api_base_url" name="api_base_url" value="{{ old('api_base_url', $application->api_base_url) }}"
            ...
            <div>
                ...
                <input type="text" id="api_client_id" name="api_client_id" value="{{ old('api_client_id', $application->api_client_id) }}"
        ...
        <div>
            <div class="flex items-center space-x-3">
                <div class="flex items-center h-10 px-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700">
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $application->is_active) ? 'checked' : '' }}
