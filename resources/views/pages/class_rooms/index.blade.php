    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <a href="{{ route('class_rooms.set_schedule') }}" class="inline-flex items-center gap-2 rounded-xl bg-blue-50 hover:bg-blue-100 px-5 py-2.5 text-xs font-bold text-blue-800 transition-all">
                <iconify-icon icon="lucide:calendar-clock" class="text-sm"></iconify-icon>
                Atur Jadwal Masuk
            </a>
            <a href="{{ route('class_rooms.create') }}" class="inline-flex items-center gap-2 rounded-xl bg-emerald-800 hover:bg-emerald-900 px-5 py-2.5 text-xs font-bold text-white transition-all shadow-sm">
