    ...
    <form action="{{ route('permissions.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="resource" name="resource" value="{{ old('resource') }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="action" name="action" value="{{ old('action') }}"
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="3"
                ...
                placeholder="Masukkan deskripsi izin">{{ old('description') }}</textarea>
            @error('description')
                <p class="mt-2 text-sm text-red-500"><i class="ti ti-alert-circle mr-1"></i>{{ $message }}</p>
            @enderror
        </div>
