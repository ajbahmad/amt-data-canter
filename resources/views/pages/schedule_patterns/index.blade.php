...
<div class="rounded-2xl border border-slate-50 bg-white p-6">
    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="datacenter-subtitle">Kelola pola jam jadwal pelajaran sekolah untuk mengatur jam masuk, pulang, dan hari libur per jenjang tingkat.</p>
        </div>
        <a href="{{ route('schedule_patterns.create') }}" class="inline-flex items-center gap-2 rounded-xl bg-emerald-800 hover:bg-emerald-900 px-5 py-2.5 text-xs font-bold text-white transition-all shadow-sm">
...
@push('scripts')
    ...
    <script>
        // Override the editData behavior to redirect to view details of the schedule pattern 
        // because setting individual days in school_day_schedules is done inside the detail view!
        function editData(id, editUrl) {
            Swal.fire({
                title: 'Kelola Pola Jadwal',
                html: 'Pola jadwal mencakup rincian jam harian. Apakah Anda yakin ingin membuka halaman pengeditan?',
                icon: 'question',
