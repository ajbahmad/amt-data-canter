...
<div class="rounded-2xl border border-slate-50 bg-white p-8">
    ...
    <div class="mb-8 pb-4 border-b border-slate-100">
        ...
        <p class="text-xs text-slate-400 mt-1">Perbarui informasi kode sekolah, nama unit lembaga, serta kontak operasional di bawah ini.</p>
    </div>

    <form action="{{ route('school_institutions.update', $schoolInstitution) }}" method="POST">
        @csrf
        @method('PUT')
