...
<div class="rounded-2xl border border-slate-50 bg-white p-8">
    ...
    <div class="mb-8 pb-4 border-b border-slate-100">
        <h2 class="text-xl font-extrabold text-emerald-800 flex items-center gap-2">
            ...
            Form Tambah Level Sekolah
        </h2>
        <p class="text-xs text-slate-400 mt-1">Daftarkan tingkatan level jenjang pendidikan (seperti SD, SMP, SMA) baru ke dalam sistem database.</p>
    </div>

    <form action="{{ route('school_levels.store') }}" method="POST">
        @csrf
