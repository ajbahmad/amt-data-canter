...
<div class="rounded-2xl border border-slate-50 bg-white p-8">
    ...
    <div class="mb-8 pb-4 border-b border-slate-100">
        ...
        <p class="text-xs text-slate-400 mt-1">Perbarui tahun ajaran akademik lengkap dengan tanggal mulai dan tanggal berakhir.</p>
    </div>
    ...
    <form action="{{ route('school_years.update', $schoolYear) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="date" id="start_date" name="start_date" value="{{ old('start_date', $schoolYear->start_date ? $schoolYear->start_date->format('Y-m-d') : '') }}" required
            ...
            <div>
                ...
                <input type="date" id="end_date" name="end_date" value="{{ old('end_date', $schoolYear->end_date ? $schoolYear->end_date->format('Y-m-d') : '') }}" required
