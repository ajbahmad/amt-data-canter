    ...
    <form action="{{ route('students.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 mb-6">
            ...
            <div>
                ...
                <input type="text" name="student_id" value="{{ old('student_id') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('student_id') border-red-500 @enderror" placeholder="Contoh: STU-00001">
                @error('student_id')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="enrollment_number" value="{{ old('enrollment_number') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('enrollment_number') border-red-500 @enderror" placeholder="Nomor pendaftaran">
            ...
            <div>
                ...
                <input type="date" name="enrollment_date" value="{{ old('enrollment_date') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('enrollment_date') border-red-500 @enderror">
        ...
        <div class="mb-6">
            ...
            <textarea name="notes" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('notes') border-red-500 @enderror" placeholder="Catatan tambahan" rows="3">{{ old('notes') }}</textarea>
            @error('notes')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('students.index') }}" class="inline-flex items-center rounded-lg bg-gray-300 px-6 py-2 text-gray-800 hover:bg-gray-400 transition">
