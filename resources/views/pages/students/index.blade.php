...
<div class="rounded-2xl border border-slate-50 bg-white p-6">
    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="datacenter-subtitle">Kelola informasi data siswa dan status pendaftaran Anda secara efisien.</p>
        </div>
        <a href="{{ route('students.create') }}" class="inline-flex items-center gap-2 rounded-xl bg-emerald-800 hover:bg-emerald-900 px-4 py-2.5 text-xs font-bold text-white transition-all shadow-sm">
