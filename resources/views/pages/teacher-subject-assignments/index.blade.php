...
<div class="rounded-lg border border-gray-200 bg-white p-6">
    ...
    <div class="mb-6 flex items-center justify-between">
        <h2 class="text-2xl font-bold text-gray-900">
            <i class="ti ti-briefcase mr-2"></i>Daftar Guru Mapel
        </h2>
        <a href="{{ route('teacher_subject_assignments.create') }}" class="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 transition">
            <i class="ti ti-plus mr-2"></i>Tambah Guru Mapel
        </a>
    </div>
